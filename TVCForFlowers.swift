...
class TVCForFlowers: UITableViewController {
    
    var flowersArry = [String]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "flowers", for: indexPath)

       cell.textLabel?.text = flowersArry[indexPath.row]
        return cell
    }
